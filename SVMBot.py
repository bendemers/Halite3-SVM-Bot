    ...
    def run(self):
        ...
        while True:
            ...
            if me.halite_amount >= constants.SHIP_COST and \
                    not game_map[me.shipyard].is_occupied and len(me.get_ships()) <= 6:
                command_queue.append(self.game.me.shipyard.spawn())
            if me.halite_amount >= 7000 and not game_map[me.shipyard].is_occupied and game.turn_number <= 250:
                command_queue.append(self.game.me.shipyard.spawn())

            #spawn another dropoff
